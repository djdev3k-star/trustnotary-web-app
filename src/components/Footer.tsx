...
const Footer = () => {
  return (
    <footer className="bg-[#142631] py-12 text-center border-t border-[#cdad7d]/20">
      <motion.div
      ...
      >
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 mb-6">
          <motion.a
            href="tel:2146854750"
            className="flex items-center space-x-2 text-gray-300 hover:text-[#cdad7d] transition-colors"
        ...
        <motion.div
          className="w-24 h-px bg-[#cdad7d]/30 mx-auto mb-6"
          initial={{ width: 0 }}
        ...
        <p className="text-gray-300 text-lg mb-2" style={{ fontFamily: 'Cormorant Garamond, serif' }}>
